    ...
    <Container maxWidth="md">
      <Box my={4}>
        ...
        <Box mt={4}>
          ...
          <Button variant="contained" color="primary" component={Link} href="/recipes">
            Explore Recipes
          </Button>
          <Button variant="contained" color="secondary" component={Link} href="/skilltrees/basic" style={{ marginLeft: '10px' }}>
            Learn Skills
          </Button>
        </Box>
      </Box>
